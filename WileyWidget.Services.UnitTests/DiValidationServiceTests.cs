    ...
    public class DiValidationServiceTests
    {
        ...
        public void ValidateRegistrations_WithResolutionError_RecordsError()
        {
            ...
            var settingsError = report.Errors.FirstOrDefault(e =>
                e.ServiceType.Contains("ISettingsService", StringComparison.Ordinal));
            Assert.NotNull(settingsError);
            Assert.Contains("Simulated dependency failure", settingsError.ErrorMessage, StringComparison.Ordinal);
        }
        ...
        public void GetDiscoveredServiceInterfaces_ReturnsKnownInterfaces()
        {
            ...
            Assert.Contains(discoveredInterfaces, name => name.Contains("ISettingsService", StringComparison.Ordinal));
            Assert.Contains(discoveredInterfaces, name => name.Contains("IAuditService", StringComparison.Ordinal));
            Assert.Contains(discoveredInterfaces, name => name.Contains("ITelemetryService", StringComparison.Ordinal));
        }
        ...
        public void GetDiscoveredServiceInterfaces_ExcludesFrameworkInterfaces()
        {
            ...
            Assert.DoesNotContain(discoveredInterfaces, name => name.Contains("IEnumerable", StringComparison.Ordinal));
            Assert.DoesNotContain(discoveredInterfaces, name => name.Contains("ICollection", StringComparison.Ordinal));
            Assert.DoesNotContain(discoveredInterfaces, name => name.Contains("IDisposable", StringComparison.Ordinal));
        }
        ...
        public void DiValidationReport_GetSummary_ReturnsFormattedString()
        {
            ...
            // Assert
            Assert.Contains("3/4 resolved", summary, StringComparison.Ordinal);
            Assert.Contains("75.0%", summary, StringComparison.Ordinal);
            Assert.Contains("1 missing", summary, StringComparison.Ordinal);
            Assert.Contains("1 errors", summary, StringComparison.Ordinal);
        }
        ...
        public void DiValidationError_ToString_IncludesSuggestedFix()
        {
            ...
            // Assert
            Assert.Contains("ITestService", result, StringComparison.Ordinal);
            Assert.Contains("Not registered", result, StringComparison.Ordinal);
            Assert.Contains("Add services.AddSingleton", result, StringComparison.Ordinal);
        }
