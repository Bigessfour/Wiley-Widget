...
LANG_BY_EXT = {
    '.py': 'Python', '.ps1': 'PowerShell', '.cs': 'C#', '.xaml': 'XAML', '.csproj': 'C# Project', '.sln': 'Solution',
    '.md': 'Markdown', '.json': 'JSON', '.yaml': 'YAML', '.yml': 'YAML', '.xml': 'XML', '.sql': 'SQL', '.sh': 'Shell'
}
CATEGORY_HINTS = [
    ('test', 'test'), ('tests', 'test'), ('scripts', 'automation'), ('tools', 'automation'), ('docs', 'documentation'), ('README', 'documentation'), ('.github', 'automation'), ('sql', 'repository'), ('src', 'source_code'), ('Views', 'views'), ('ViewModels', 'viewmodels')
]
...
def main(argv=None):
    parser = argparse.ArgumentParser(description='Generate ai-fetchable-manifest.json for repo')
