...
/// <summary>
/// ViewModel for managing utility customers. Wrapped in file-scoped namespace and class for MVVM binding.
/// </summary>
public partial class CustomersViewModel : ViewModelBase, ICustomersViewModel
{
    ...
    // Core collections and selection
    [ObservableProperty]
    ...
    public CustomersViewModel(
        ...
        IQuickBooksService quickBooksService) : base(logger)
    {
    ...
    // Sample population removed — production repositories must supply customer data.
    ...
    private async Task SaveSelectedCustomerAsync(CancellationToken cancellationToken = default)
    {
        ...
        await SaveCustomerAsync(SelectedCustomer, cancellationToken);
    }
    ...
    public Task<WileyWidget.WinForms.Controls.Base.ValidationResult> ValidateAsync(CancellationToken ct = default)
    {
        // Basic validation - can be expanded
        if (!Customers.Any())
        {
            return Task.FromResult(WileyWidget.WinForms.Controls.Base.ValidationResult.Success);
        }
    ...
    public Task<WileyWidget.WinForms.Controls.Base.ValidationResult> SaveAsync(CancellationToken ct = default)
    {
