...
#pragma warning restore CS4014
        ...
        private void InitializeComponent()
        {
            ...
            AddRow(basicLayout, "🏷️ Account #:", _accountNumberBox, ref row);
            ...
            AddRow(serviceLayout, "🏛️ City:", _serviceCityBox, ref row);
            AddRow(serviceLayout, "🗺️ State:", _serviceStateBox, ref row);
            ...
            AddRow(mailingLayout, "🏛️ City:", _mailingCityBox, ref row);
            AddRow(mailingLayout, "🗺️ State:", _mailingStateBox, ref row);
        ...
        /// <summary>
        /// Applies the global Syncfusion theme to the form and its controls.
        /// </summary>
        private void ApplySyncfusionTheme()
        {
            // If a Syncfusion SkinManager is loaded, prefer it; otherwise apply manual fallback colors
            if (Syncfusion.Windows.Forms.SkinManager.ContainsSkinManager)
            {
                try
                {
                    Syncfusion.Windows.Forms.SkinManager.SetVisualStyle(this, "Office2019DarkGray");
                }
                catch { }
            }
            else
        ...
        private void ShowValidationMessage(string? message)
        {
            ...
            {
                _validationLabel.Text = $"⚠️ {message}";
