...
namespace WileyWidget.WinForms.Services.AI
{
    ...
    public static class KernelPluginRegistrar
    {
        ...
        public static void ImportPluginsFromAssemblies(Kernel kernel, IEnumerable<Assembly> assemblies, ILogger? logger = null)
        {
            ...
            foreach (var assembly in distinctAssemblies)
            {
                ...
                foreach (var pluginType in pluginTypes)
                {
                    try
                    {
                        ImportPluginFromType(kernel, pluginType, logger);
                    }
                    catch (Exception ex)
                    {
        ...
        private static void ImportPluginFromType(Kernel kernel, Type pluginType, ILogger? logger)
        {
