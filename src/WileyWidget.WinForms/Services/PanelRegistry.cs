...
namespace WileyWidget.WinForms.Services
{
    ...
    public static class PanelRegistry
    {
        ...
        public static readonly IReadOnlyList<PanelEntry> Panels = new List<PanelEntry>
        {
            ...
            new PanelEntry(typeof(WileyWidget.WinForms.Controls.Panels.FormHostPanel), "Dashboard", DockingStyle.Top, false),
            ...
            new PanelEntry(typeof(WileyWidget.WinForms.Controls.Panels.FormHostPanel), "Rates", DockingStyle.Right),
