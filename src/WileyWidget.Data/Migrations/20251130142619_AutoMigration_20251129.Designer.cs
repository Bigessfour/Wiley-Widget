...
namespace WileyWidget.Data.Migrations
{
    ...
    [Migration("20251130142619_AutoMigration_20251129")]
    partial class AutoMigration_20251129
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WileyWidget.Models.Entities.AccountTypeEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            Id = 2,
                            CreatedAt = new DateTime(2025, 10, 1, 0, 0, 0, 0, DateTimeKind.Utc),
                            Description = "Expenditure and expense accounts",
                            IsDebit = true,
                            TypeName = "Expense"
                        },
                        new
                        ...
                        new
                        {
                            Id = 5,
                            CreatedAt = new DateTime(2025, 10, 1, 0, 0, 0, 0, DateTimeKind.Utc),
                            Description = "Equity and fund balance accounts",
                            IsDebit = false,
                            TypeName = "Equity"
                        },
                        new
                        ...
                        new
                        {
                            ...
                            IsDebit = false,
                            TypeName = "Other Current Liability"
                        },
                        new
                        {
                            Id = 15,
                            ...
                            IsDebit = false,
                            TypeName = "Long Term Liability"
                        });
                });

            modelBuilder.Entity("WileyWidget.Models.Entities.ChartOfAccountEntry", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("AccountNumber", "FundId")
                        .IsUnique();
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 7,
                            AccountName = "SALARIES EMPLOYEES",
                            AccountNumber = "401",
                            AccountTypeId = 2,
                            CreatedAt = new DateTime(2025, 10, 1, 0, 0, 0, 0, DateTimeKind.Utc),
                            FundId = 1,
            ...
            modelBuilder.Entity("WileyWidget.Models.Entities.Fund", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2025, 10, 1, 0, 0, 0, 0, DateTimeKind.Utc),
                            Description = "Town of Wiley General Operating Fund",
                            FundCode = "TOWN-GENERAL",
                            IsActive = true,
                            Name = "Town General Fund",
                            Type = 1
                        },
                        new
                        {
                            Id = 2,
                            CreatedAt = new DateTime(2025, 10, 1, 0, 0, 0, 0, DateTimeKind.Utc),
                            Description = "Wiley Recreation Fund",
                            FundCode = "WILEY-REC",
                            IsActive = true,
                            Name = "Wiley Rec",
                            Type = 3
                        ...
                        new
                        {
                            Id = 4,
                            CreatedAt = new DateTime(2025, 10, 1, 0, 0, 0, 0, DateTimeKind.Utc),
                            Description = "Wiley Sanitation District - General Fund",
                            FundCode = "WSD-GENERAL",
                            IsActive = true,
                            Name = "WSD General",
                            Type = 2
                        },
                        new
                        {
                            Id = 5,
                            CreatedAt = new DateTime(2025, 10, 1, 0, 0, 0, 0, DateTimeKind.Utc),
                            Description = "Wiley Community Center Fund",
                            FundCode = "WILEY-CC",
                            IsActive = true,
                            Name = "Wiley Community Center",
                            Type = 3
                        },
                        new
                        {
                            Id = 6,
                            CreatedAt = new DateTime(2025, 10, 1, 0, 0, 0, 0, DateTimeKind.Utc),
                            Description = "Wiley Housing Authority - Brookside",
                            FundCode = "WHA-BROOKSIDE",
                            IsActive = true,
                            Name = "WHA Brookside",
                            Type = 2
                        });
            ...
            modelBuilder.Entity("WileyWidget.Models.Entities.ChartOfAccountEntry", b =>
                {
                    b.HasOne("WileyWidget.Models.Entities.AccountTypeEntity", "AccountType")
                    ...
                    b.HasOne("WileyWidget.Models.Entities.ChartOfAccountEntry", "ParentAccount")
