        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FirstMentionedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    LastMentionedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AIContextEntities", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    InitialContext = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    MetadataJson = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.InsertData(
                table: "MunicipalAccounts",
                columns: new[] { "Id", "Balance", "BudgetAmount", "BudgetPeriodId", "DepartmentId", "Fund", "FundDescription", "IsActive", "LastSyncDate", "Name", "Notes", "ParentAccountId", "QuickBooksId", "Type", "TypeDescription", "AccountNumber" },
                values: new object[,]
                {
                    { 26, 0m, 0m, 1, 1, 8, "Conservation Trust Fund", true, null, "MISC EXPENSE", null, null, null, 24, "Asset", "425" },
                    { 27, 0m, 0m, 1, 1, 8, "Conservation Trust Fund", true, null, "TRAIL MAINTENANCE", null, null, null, 24, "Asset", "430" },
                    { 28, 0m, 0m, 1, 1, 8, "Conservation Trust Fund", true, null, "PARK IMPROVEMENTS", null, null, null, 29, "Asset", "435" },
                    { 29, 0m, 0m, 1, 1, 8, "Conservation Trust Fund", true, null, "EQUIPMENT PURCHASES", null, null, null, 29, "Asset", "440" },
                    { 30, 0m, 0m, 1, 1, 8, "Conservation Trust Fund", true, null, "PROJECTS - SMALL", null, null, null, 24, "Asset", "445" },
                    { 31, 0m, 0m, 1, 1, 8, "Conservation Trust Fund", true, null, "RESERVES ALLOCATION", null, null, null, 30, "Asset", "450" }
                });

            migrationBuilder.CreateIndex(
                name: "IX_AIContextEntities_ConversationId",
                table: "AIContextEntities",
                column: "ConversationId");

            migrationBuilder.CreateIndex(
                name: "IX_AIContextEntities_IsActive_Filtered",
                table: "AIContextEntities",
                column: "IsActive",
                filter: "[IsActive] = 1");

            migrationBuilder.CreateIndex(
                name: "IX_AIContextEntities_LastMentionedAt",
                table: "AIContextEntities",
                column: "LastMentionedAt",
                descending: new bool[0]);

            migrationBuilder.CreateIndex(
                name: "IX_AIContextEntities_Type_NormalizedValue",
                table: "AIContextEntities",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ConversationHistories_IsArchived_Filtered",
                table: "ConversationHistories",
                column: "IsArchived",
                filter: "[IsArchived] = 0");
