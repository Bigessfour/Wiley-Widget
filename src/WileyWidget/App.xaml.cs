...
//
// PARTIAL CLASS STRUCTURE (Phase 3 Complete, 2025-11-12):
// This class is split into 5 partial files (~1,800 LOC total) for maintainability:
//
...
//    - OnStartup: 3-phase startup (validation → resources/theme → Prism)
...
//
// 4. App.ResourcesAndTelemetry.cs (~400 LOC) - Resource loading, theme & telemetry
...
//
// 5. App.ExceptionHandling.cs - Global exception handling
        ...
        static App()
        {
            ...
            Log.Logger = new LoggerConfiguration()
                ...
                .WriteTo.File(
                    ...
                    flushToDiskInterval: TimeSpan.Zero)  // Flush immediately for async module logging
                .WriteTo.File(
