...
### UI Platform: WinUI 3 Migration (November 2025)

**Current Status**: Migrated from WPF to WinUI 3
**Target Framework**: .NET 9.0-windows10.0.19041.0
**UI Framework**: Microsoft.UI.Xaml (WinUI 3)
**Syncfusion Controls**: Syncfusion WinUI (https://help.syncfusion.com/winui/overview)

**Migration Rules**:
- All new UI code must use WinUI 3 controls (`Microsoft.UI.Xaml.*`)
- Syncfusion controls must reference WinUI equivalents, NOT WPF
- XAML namespaces use `http://schemas.microsoft.com/winfx/2006/xaml/presentation` for WinUI
- Resource dictionaries use `ms-appx:///` URIs for WinUI resource loading
- Custom region adapters target WinUI controls (e.g., `Microsoft.UI.Xaml.Controls.Frame`)

**Documentation References**:
- WinUI 3 Docs: https://learn.microsoft.com/en-us/windows/apps/winui/winui3/
- Syncfusion WinUI: https://help.syncfusion.com/winui/overview
- Prism WinUI: Use Prism 9.x with WinUI 3 compatibility
