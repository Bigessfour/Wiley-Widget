...
namespace WileyWidget.Models
{
    public class AppDbContext : DbContext
    {
        ...
        public DbSet<MunicipalEnterprise> MunicipalEnterprises { get; set; }
...
namespace WileyWidget.Services
{
    public class WidgetRepository : IWidgetRepository
    {
        ...
        public async Task<IEnumerable<MunicipalEnterprise>> GetAllMunicipalEnterprisesAsync()
        {
            return await _context.MunicipalEnterprises
                .OrderBy(w => w.Name)
                .ToListAsync();
        }

        public async Task<MunicipalEnterprise?> GetMunicipalEnterpriseByIdAsync(int id)
        {
            return await _context.MunicipalEnterprises.FindAsync(id);
        }

        public async Task<MunicipalEnterprise> AddMunicipalEnterpriseAsync(MunicipalEnterprise municipalEnterprise)
        {
            _context.MunicipalEnterprises.Add(municipalEnterprise);
            await _context.SaveChangesAsync();
            return municipalEnterprise;
        }

        public async Task UpdateMunicipalEnterpriseAsync(MunicipalEnterprise municipalEnterprise)
        {
            municipalEnterprise.ModifiedDate = DateTime.UtcNow;
            _context.MunicipalEnterprises.Update(municipalEnterprise);
            await _context.SaveChangesAsync();
        }
