...
public partial class MainWindow : Window
{
    ...
    public MainWindow()
    {
        ...
        try
        {
            ...
            Loaded += OnLoaded; // retain for late-bound adjustments, not initial theming
    ...
    // Fallback stub: In case the auto-generated InitializeComponent partial class is not produced
    // (e.g., path or XAML build action discrepancies), provide a minimal no-op to avoid compile failure.
    // If the generated method exists, this will be ignored at link time (partial duplication avoided by conditional compile symbol).
