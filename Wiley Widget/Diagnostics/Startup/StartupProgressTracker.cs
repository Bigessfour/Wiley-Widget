...
namespace WileyWidget.Diagnostics.Startup;
...
public class StartupProgressTracker
{
    ...
    public void AdvanceStep()
    {
        ...
        {
            Serilog.Log.Information("🚀 Startup Progress: {CurrentStep}/{TotalSteps} ({StartupProgress:F1}%) - {_steps[_currentStep - 1]}", _currentStep, _totalSteps, progress);
        }
    }
