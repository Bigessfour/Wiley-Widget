...
Output JSON array: [{{""name"": ""string"", ""deficit"": 0.0, ""suggestedHike"": 0.0, ""suggestion"": ""string. I'm not your accountant, but this trend screams 'double-check'—have your CPA confirm.""}}]";
        ...
        /// <summary>Historical snapshot record (internal DTO for trend analysis).</summary>
        ...
        /// Gathers recent snapshots then combines with current enterprises to request trend
        /// predictions and actionable suggestions from the AI service.
        /// </summary>
        ...
        /// <remarks>Uses last 10 snapshots plus current enterprise set.</remarks>
...
Remember: I'm not your accountant, but this trend screams 'double-check'—have your CPA confirm.";
        ...
        /// <summary>AI budget analytics response DTO (internal parsing only).</summary>
        ...
        /// Aggregates totals, balance, citizen counts, averages, and efficiency ratios.
        /// </summary>
        /// <param name="enterprises">All enterprises for comprehensive aggregation.</param>
        /// <returns>BudgetMetrics with computed aggregate analytics.</returns>
        /// <remarks>Falls back to deterministic calculations if AI call fails.</remarks>
...
Remember: I'm not your accountant, but this trend screams 'double-check'—have your CPA confirm.";
        ...
        /// <summary>AI budget insights response DTO (internal parsing only).</summary>
        internal class BudgetInsightsResult
        {
    ...
    /// <param name="enterprises">Enterprise data set used for recommendation context.</param>
    /// <returns>BudgetInsights object with AI-generated analysis and recommendations.</returns>
    /// <remarks>Combines deterministic aggregation with AI narrative/enrichment.</remarks>
...
";
    ...
    // Duplicate DTO definitions were removed; retained earlier single source.
    }
}
