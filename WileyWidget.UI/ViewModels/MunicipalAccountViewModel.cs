    ...
    private async Task RestoreStateAsync()
    {
        try
        {
            ...
            if (state is MunicipalAccountViewModelState viewModelState)
            {
                ...
                // SelectedDepartmentFilter = Departments?.FirstOrDefault(d => d.Id == viewModelState.SelectedDepartmentId); // TODO: Load departments first
    ...
    private async Task AddAccountAsync()
    {
        ...
        try
        {
            ...
            var newAccount = new MunicipalAccount
            {
                ...
                BudgetPeriodId = 1, // Default budget period - TODO: Get from current context
