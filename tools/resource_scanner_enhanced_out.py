...
def main(argv):
    parser = argparse.ArgumentParser(
        description="Resource scanner (enhanced) + atomic output"
    )
    parser.add_argument(
        "--paths",
        type=str,
    ...
    parser.add_argument(
        "--output",
        type=str,
        help="file path to write a summary JSON output",
        default="logs/resource_scan_summary.json",
    )
    ...
    summary = {"total": len(found), "sample": found[:50]}
