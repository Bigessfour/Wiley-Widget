...
def attempt_atomic_write(target: Path, cycles: int = 1000, delay: float = 0.001, retries: int = 6):
    success = 0
    failures = 0
    errors = {}
...
def main(argv):
    ...
    s, f, errors = attempt_atomic_write(target, cycles=args.cycles, delay=args.delay, retries=args.retries)
