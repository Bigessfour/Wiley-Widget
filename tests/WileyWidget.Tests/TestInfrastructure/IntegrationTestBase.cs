...
using WileyWidget.Tests.TestInfrastructure.Doubles;
using Serilog;

namespace WileyWidget.Tests.TestInfrastructure;
...
public abstract class IntegrationTestBase : IDisposable
{
    ...
    protected IntegrationTestBase()
    {
        ...
        services.AddSingleton<IAIService, NullAIServiceDouble>();
        services.AddSingleton<IGrokSupercomputer, NullGrokSupercomputerDouble>();
