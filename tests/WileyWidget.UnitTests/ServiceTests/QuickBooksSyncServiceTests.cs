...
namespace WileyWidget.Services.Tests.ServiceTests
{
    public class QuickBooksSyncServiceTests
    {
        ...
        public async Task SyncBudgetsToAppAsync_PartialFailure_ReturnsPartialResult()
        {
            ...
            using var service = new QuickBooksService(mockSettings.Object, mockSecretVault.Object, mockLogger.Object, mockApiClient.Object, httpClient, new Mock<IServiceProvider>().Object, mockTransactionRepo.Object);
